 ...
 */
public class ReaderAccess extends AsyncTask<String, String, String>
{
    private Context mContext;
    ProgressDialog mProgress;
    private OnReaderTaskCompleted mCallback;

    public ReaderAccess(Context context, OnReaderTaskCompleted listner)
    {
    ...
    protected void onPostExecute(String message)
    {
        //process message
        mProgress.dismiss();
        mCallback.OnReaderTaskCompleted(message);
    }
    ...
    private String getServerInfo(String IMEI)
    {
        String reply1="";
        URI uri = null;
        try {

            uri = new URI("http://gabmseb.azurewebsites.net/msebservice.svc/checkreader");
